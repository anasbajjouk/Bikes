            ...
            <div class="footer-right">
                <div class="tz-widget-clients widget">
                    ...
                    <div class="tz-widget-say">
                        <img src="{{ asset('images/say.jpg')}}" alt="Kathy Young">
                        <div class="entry-say">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <p>Copyright &copy; 2018 <a href="http://templaza.com/" target="_blank">BikeSport</a> by TemPlaza - plazart. All rights reserved.</p>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="pull-right">
                        <span class="payments-method">
                            <a href="#"><img src="{{ asset('images/Visa.png') }}" alt="visa"></a>
                            <a href="#"><img src="{{ asset('images/Intersection.png') }}" alt="Intersection"></a>
                            <a href="#"><img src="{{ asset('images/ebay.png') }}" alt="ebay"></a>
                            <a href="#"><img src="{{ asset('images/Amazon.png') }}" alt="Amazon"></a>
                            <a href="#"><img src="{{ asset('images/Discover.png') }}" alt="Discover"></a>
                        </span>
                    </div>
                </div>
            </div>
