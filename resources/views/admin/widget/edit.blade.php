    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                  <form role="form" method="POST" action="{{ route('widget.update', $products->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="category_id" id="category_id" required="">
                        ...
                        <option value="{{ $products->category_id }}">Old Category : {{ $proCatName }}</option>
