  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
                  ...
                  <tr>
                    ...
                    <td width="200px" class="text-center">
                      ...
                      {!! Form::open(['method' => 'DELETE', 
                                      'route' => ['widgetCategory.destroy', $category->id] ,
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="{{ route('widgetCategory.update',$category->id) }}" method="POST" role="form">
                                {{ csrf_field() }}
                                {{ method_field('PATCH') }}
          ...
          <div class="box-body">
            <form role="form" method="POST" action="{{ route('widgetCategory.store')}}" enctype="multipart/form-data">
