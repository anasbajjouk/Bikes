                  ...
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class=" col-md-9 col-lg-9"> 
                        ...
                        {!! Form::open( [ 'files' => true, 'method' => 'PATCH' , 'route' => ['user.update', $user->id] ] ) !!}
                          ...
                          <a class="btn btn-primary" href="{{ route('user.getPassword', $user->id) }}">Change Password</a>
