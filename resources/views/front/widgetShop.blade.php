            ...
            <div class="col-md-3">
                ...
                <div class="tz-shop-sidebar">
                    <aside class="widget widget_product_categories">
                        ...
                        <form method="GET" action="{{ route('front.widgetshop') }}">
                    ...
                    <aside class="widget widget_product">
                        <h3 class="widget-title">Featured widgets</h3>
                        <ul>
                            @foreach($randomWidgets as $randomWidget)
                                <li>
                                    <a href="{{ route('front.widgetDetail', $randomWidget->id) }}">
                                        <img src="{{ asset($randomWidget->image) }}" alt="{{ $randomWidget->name }}">
                                        <div class="item-info">
                                            <h5>{{ $randomWidget->name }}</h5>
                                             <span class="p-vote">
                                                <br>
                                            </span>
                                            <span class="price">${{ $randomWidget->price }}</span>
                                        </div>
                                    </a>
                                </li>
                            @endforeach
                ...
                <div class="tz-shop-content">
                                ...
                                <div class="item">
                                    <div class="product-item-inner">
                                        <div class="product-thumb">
                                            <img src="{{ asset($widget->image) }}" alt="{{ $widget->name }}" width="170px">
                                        </div>
                                        <div class="product-info">
                                            <h4><a href="{{ route('front.widgetDetail',$widget->id)}}">{{ $widget->name }}</a></h4>
                                            <span class="p-meta">
                                                <span class="p-price">${{ $widget->price }}</span>
                                                <span class="p-vote">
                                            ...
                                            <span class="p-mask">
                                                <a href="{{ route('front.widgetDetail',$widget->id)}}" class="add-to-cart">Add to cart</a>
                                               <span class="quick-view">
                                                    <a href="{{ route('front.widgetDetail',$widget->id)}}"><i class="fa fa-eye"></i> Quick view</a>
                                                </span>
                                            </span>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4 col-lg-offset-4 col-xs-8 col-xs-offset-3">
                       <ul class="pager">
                            ...
                            {{ $widgets->appends(['number_item' => $number_item ,
                                                     'min_price' => $min_price,
                                                     'max_price' => $max_price,
                                                     'brand' => $brand,
                                                     ])->links() }}
...
<script type="text/javascript">
    $('form').submit(function( event ) {
        ...
        $.ajax({
            url: 'http://bikesport.dev/front/widgetshop',
            type: 'post',
